...
function Register({ setUser }) {
  ...
  return (
    <div className='my-32'>
      <h1 className="flex justify-center mb-4 text-large font-extrabold leading-none tracking-tight text-lime-900 md:text-5xl lg:text-6xl">Register</h1>
      <form onSubmit={handleSubmit}>
        <label className=" text-lg font-normal text-gray-500 lg:text-xl  dark:text-gray-400" htmlFor="username">Username:</label>
        <br />
        <input
        ...
        <br />
        <br />
        <label className=" text-lg font-normal text-gray-500 lg:text-xl  dark:text-gray-400" htmlFor="email">Email:</label>
        <br />
        <input
        className="mt-4 w-full rounded border-2 bg-white px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
          type="email"
        ...
        <br />
        <br />
        <label className=" text-lg font-normal text-gray-500 lg:text-xl  dark:text-gray-400" htmlFor="password">Password:</label>
        <br />
        <input
        className="mt-4 w-full rounded border-2 bg-white px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
          type="password"
